...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
        ...
        In semantic HTML, each tag convayes the meaning/ purpose of it own content.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

        block goes to the next line, inline does not.
        also inline item do not respect hieght, nor top and bottom margins.
...
5. Explain why git is valuable to a team of developers.
        ...
        It allows developer collabrate while work seperatly, then latter merge contributions.
        also, it allow for revions to earlier states when needed.
